  ...
  return (
    <Container centerContent>
      <Flex mt="80px" p="15px" maxH="auto" maxW="auto" flexDirection="column">
        ...
        <Box maxW={{ base: 250, lg: 500 }} marginX="auto" mt={{base: "80px", lg: "150px"}} bgColor="black" p="20px" textAlign="justify">
        ...
        <Box w={{base: 200, lg: 300}} h={{base: 200, lg: 300}} mx="auto" mt="40px" position="relative">
          <Image fill="true" objectFit="contain" src="/SVG-nba.svg"/>
        </Box>
      </Flex>
    </Container>
  )
